...
`),this.data.events.forEach(t=>e+=t.toString()),e+=f(this.data),e+=`END:VCALENDAR`,l(e)}ttl(e){return e===void 0?this.data.ttl:(g(e)?this.data.ttl=e.asSeconds():e&&e>0?this.data.ttl=e:this.data.ttl=null,this)}url(e){return e===void 0?this.data.url:(this.data.url=e||null,this)}x(e,t){if(e===void 0)return i(this.data);if(typeof e==`string`&&typeof t==`string`)i(this.data,e,t);else if(typeof e==`object`)i(this.data,e);else throw Error(`Either key or value is not a string!`);return this}};function W(e){return new U(e)}export{F as ICalAlarm,P as ICalAlarmRelatesTo,N as ICalAlarmType,M as ICalAttendee,O as ICalAttendeeRole,A as ICalAttendeeStatus,j as ICalAttendeeType,U as ICalCalendar,H as ICalCalendarMethod,I as ICalCategory,V as ICalEvent,L as ICalEventBusyStatus,R as ICalEventClass,e as ICalEventRepeatingFreq,z as ICalEventStatus,B as ICalEventTransparency,t as ICalEventTravelTimeSuggestion,n as ICalEventTravelTimeTransportation,r as ICalWeekday,W as default,c as escape,l as foldLines,u as formatDate,d as formatDateTZ};
